...
const convertMatchDetailsDbobjectToResposeObject = (dbObject) => {
  return {
...
app.get("/matches/:matchId/", async (request, response) => {
  ...
  response.send(convertMatchDetailsDbobjectToResposeObject(matchDetails));
});
...
app.get("/players/:playerId/matches/", async (request, response) => {
  ...
  response.send(
    playerMatches.map((eachMatch) =>
      convertMatchDetailsDbobjectToResposeObject(eachMatch)
    )
  );
});
